...
fun getMe(context: Context): String? = runBlocking {
    ...
    token = job.await() // aspetta il risultato
    ...
    try {
        val response: HttpResponse = myHttpClient.get("http://192.168.1.212:8060/api/utente/me") {
